  ...
  return (
    <TooltipProvider>
      ...
      <main className="lg:pl-20">
        <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b px-4 bg-background border-border sm:gap-x-6 sm:px-6 lg:px-8">
          <Button 
            size="icon" 
            variant="ghost" 
              ...
              <div className="flex grow flex-col gap-y-5 bg-background">
                <div className="flex h-16 shrink-0 items-center gap-x-4">
                  <img
                    ...
                    alt="Nitric Logo"
                  />
                  <span className="max-w-96 truncate font-semibold dark:text-gray-200">
                    {data?.projectName}
                  </span>
                </div>
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="ml-auto flex items-center gap-x-4 lg:gap-x-6">
              ...
              <div className="hidden items-center gap-x-2 lg:flex">
                <span className="font-semibold dark:text-gray-200">Local Dashboard</span>
                <ThemeToggle />
              </div>
              <div className="relative">
                <Popover>
                  <PopoverTrigger asChild>
                    <Button 
                      variant="outline" 
                      className="group font-semibold dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                    >
                      <QuestionMarkCircleIcon
                        className="mr-2 h-5 w-5 text-gray-500 transition duration-150 ease-in-out group-hover:text-opacity-80 group-data-[state=open]:text-opacity-90 dark:text-gray-400"
                        aria-hidden="true"
                      />
                      <span>Help</span>
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="mr-2 w-screen max-w-md flex-auto overflow-hidden rounded-3xl bg-white p-0 text-sm leading-6 shadow-lg ring-1 ring-gray-900/5 dark:bg-gray-900 dark:ring-gray-800">
                    <div className="p-4">
                      <h3 className="font mb-2 text-center text-sm font-semibold leading-6 text-gray-500">
