...
const NavigationBar: React.FC<NavigationBarProps> = ({
  ...
  return (
    <nav
      ...
      className={cn(
        'group hidden flex-col overflow-hidden border-r lg:fixed lg:inset-y-0 lg:left-0 lg:z-50 lg:flex lg:w-20 lg:overflow-y-auto lg:pb-4 lg:data-[state=expanded]:w-52',
