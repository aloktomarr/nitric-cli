      ...
      <div className="hidden sm:block">
        <nav
          className={cn(
            pill
              ? 'flex space-x-4'
              : 'isolate flex divide-x divide-gray-200 rounded-t-lg shadow dark:divide-border',
            round && 'rounded-lg',
          )}
          aria-label="Tabs"
        >
          {tabs.map((tab, tabIdx) => (
            <button
              ...
              className={cn(
                tabIdx === index
                  ? pill
                    ? 'bg-gray-100 text-gray-700 dark:bg-muted dark:text-foreground'
                ...
                pill
                  ...
                  : 'group relative min-w-0 flex-1 overflow-hidden bg-white px-4 py-4 text-center text-sm font-medium hover:bg-gray-50 focus:z-10 dark:bg-background dark:hover:bg-muted',
              )}
            ...
            >
              ...
              {tab.count ? (
                <span
                  className={cn(
                    tabIdx === index
                      ? 'bg-indigo-100 text-primary dark:bg-primary/20'
